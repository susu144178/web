...
public class SocketProvider extends TextWebSocketHandler {
    ...
    @Override
    protected void handleTextMessage(WebSocketSession webSocketSeesion, TextMessage textMessage) throws Exception {
        String messagePayload = textMessage.getPayload();
        
        String room = webSocketSeesion.getHandshakeHeaders().getFirst("room");
