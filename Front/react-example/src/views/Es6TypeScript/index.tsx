...
export default function Es6Typescript() {
    ...
    //! 역으로 생각했을 때 데이터 타입이 지정된 변수는 필수적으로 값이 표함되어 있어야 한다는 뜻
    // let variable3: string = null;

    //? & : 한 변수에 두 개의 데이터 타입의 속성을 동시에 지정할 때 사용
    interface I1 {
      a: string;
    }
    interface I2 {
    ...
    //# 5. if
    //? if문의 조건
    //? ES6와 TS에서는 false, '', 0, {}, [], null, undefined 를 모두 false로 받고 나머지는 모두 true
    ...
    //! 객체형의 데이터 타입을 지정할 때는 3가지 방법을 쓸 수 있음
    //^ 1. interface 사용
    //^ 2. class 사용
    class Example {
      a: string;
    ...
    // const object4: TExample = { a: 'a', b: 1, c: true };
