...
import GetTop15RelatedWordResponseDto from './Get-Top15-Related-Search-Word.response.dto';
...
import PatchBoardResponseDto from './Patch_Board.response.dto';
...
export type {
    ...
    GetTop15RelatedWordResponseDto,
