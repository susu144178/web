...
import { Avatar, Box, Card, Typography, CardActionArea } from "@mui/material";
        ...
        >
          <Box sx={{ p: "24px" }}>
            ...
            <Box sx={{ mt: "16px", mb: "16px" }}>
              <Typography
                sx={{ fontSize: "16px", fontWeight: 500, color: "#ffffff" }}
              >
                {previewItem.boardTitle}
              </Typography>
              <Typography
                sx={{
                  mt: "5px",
            ...
            <Box>
              ...
              >{`댓글 ${previewItem.commentCount} · 좋아요 ${previewItem.likeCount} · 조회수 ${previewItem.viewCount}`}</Typography>
            </Box>
          </Box>
        </Box>
      </CardActionArea>
