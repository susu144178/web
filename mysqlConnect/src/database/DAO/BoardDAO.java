...
public class BoardDAO {
	...
	public int insert(InsertBoardDTO dto) {
		...
		SimpleDateFormat simplaDateFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
		...
		try {
			...
			preparedStatement.setString(3, simplaDateFormat.format(new Date()));
	...
	// 데이터베이스에서 Board 테이블 중 id에 해당하는 레코드를 삭제
